        ...
        <>
            <div className='my-4 border rounded-md flex flex-row w-full p-2  bg-gray-100'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <div>
                        <label className='text-gray-500 text-sm'>助手: <span className='ml-2'>{showAssistantLabel()}</span></label>
                    </div>
                    <div>
                        <label className='text-gray-500 text-sm'>專家: <span className='ml-2'>{showExpertLabel()}</span></label>
                    </div>
                </div>
