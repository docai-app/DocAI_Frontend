...
export default function GenerateView(props: GenerateViewProps) {
    const { document, handleQuery, open,
        setOpen, generateContent, setGenerateContent, setAlert } = props;
                        ...
                        <div className="px-4 pb-8 sm:px-0">
                            <div className="flex justify-center md:items-center flex-col md:flex-row p-0 border-0 border-dashed border-gray-200 bg-white h-80vh">
                                ...
                                <div className="right-side flex-1 flex flex-col overflow-auto h-5/6 py-2 pl-2">
                                    ...
                                    <label className="flex justify-start text-sm text-gray-500 ">根據文件內容生成你想要的內容</label>
                                    ...
                                    <div className="mt-2 text-sm flex items-center justify-end">
                                        ...
                                        <a
                                            ...
                                            onClick={() => {
                                                ...
                                                setAlert({ title: '已複製到粘貼板', type: 'success' })
                                            }}
                                        >
                                            複製生成的內容
                                        </a>
