    ...
    return (
        <>
                ...
                <div className="flex flex-1 flex-col">
                    ...
                    <div className="flex px-2 items-center justify-between">
                        <div className="flex flex-row items-center">
                            ...
                            <label className="text-xs ml-4 text-gray-400">截止日期: {project?.deadline_at && moment(project?.deadline_at).format("YYYY-MM-DD")}</label>
                        </div>

                        <div className="flex flex-row items-center">
                            <CogIcon className="w-4" onClick={() => { setVisiable(true) }} />
                        </div>
            ...
            <EditProjectModal
                ...
                confirmClick={(data: any) => { setVisiable(false); updateProjectHandler(data) }}
            />
        </>
    )
}