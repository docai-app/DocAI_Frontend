...
export default function AssistiveQuestionViewContainer() {
    ...
    const [{ data: updateChatbotAssistiveQuestionsByIdData, loading: updateing }, updateChatbotAssistiveQuestionsById] = useAxios(
    ...
    useEffect(() => {
        if (updateChatbotAssistiveQuestionsByIdData && updateChatbotAssistiveQuestionsByIdData.success) {
