        ...
        <>
            <div className='my-4 border rounded-md flex flex-row w-full p-2  bg-gray-100'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <div className="mt-2">
                        <label className='text-gray-500 text-sm'>顯示標題:<span className='ml-2'>推薦功能</span> </label>
                    </div>
                    <div>
                        <label className='text-gray-500 text-sm'>Chain Feature: <span className='ml-2'>{chain_feature_labels}</span></label>
                    </div>
                </div>
