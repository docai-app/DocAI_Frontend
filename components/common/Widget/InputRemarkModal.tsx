            ...
            <div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-center overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div className="sm:flex sm:items-center justify-center">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <Dialog.Title as="h3" className="flex flex-row text-sm leading-6 font-medium text-gray-900">
                    <EyeIcon className="h-6 w-6 mr-2 text-blue-600" aria-hidden="true" />
                    請填寫資料審批
                  </Dialog.Title>
                  <div className="mt-2">
                    ...
                    <span dangerouslySetInnerHTML={{
                        __html: props.status == 'approved' ? '你批准了這份文檔' : '你拒絕了這份文檔'
                      }} className={`text-xl ${props.status == 'approved' ? 'text-green-500' : 'text-red-500'}`}>
              ...
              <div className='w-full mt-4'>
                <div className='w-full'>
                  ...
                  <input type={'text'} name="signature" className="w-3/4 ml-2 rounded-md"
                  onChange={(e) => setData({
                    ...data,
                    approval: props.approval,
                ...
                <div className='w-full mt-2'>
                  ...
                  <input type={'text'} name="remark" className="w-3/4 ml-2 rounded-md"
                  onChange={(e) => setData({
                    ...data,
                    approval: props.approval,
