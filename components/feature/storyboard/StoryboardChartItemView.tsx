...
export default function StoryboardChartItemView(props: Props) {
    ...
    return (
        <>
            <div className="rounded-lg border border-gray-300 bg-white px-4 py-2 shadow-sm flex items-center space-x-3  focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
