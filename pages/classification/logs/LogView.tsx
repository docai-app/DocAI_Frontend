                                    ...
                                    return (
                                        <div className='mt-6' key={index}>
                                            ...
                                            <div className='flex flex-row items-center my-2'>
                                                ...
                                                {
                                                    item.status == 'doing' && <a className='p-2 text-sm underline text-indigo-500' href={'/classification/validate'}>繼續處理</a>
                                                }
                                                {
                                                    item.status == 'finish' && <a className='p-2 text-sm underline text-indigo-500' href={''}>查看</a>
                                                }
                                            </div>
                                            
                                            {
                                                ...
                                                <div className='flex flex-row items-center'> 
                                                    ...
                                                    <p className='ml-1 text-green-500 text-sm'>{item.other}</p>
                                                </div>
                                            }
                                        </div>
                                    )
